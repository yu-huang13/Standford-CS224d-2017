...
def getSentenceFeatures(tokens, wordVectors, sentence):
    ...
    ### YOUR CODE HERE
    indicies = map(lambda word: tokens[word], sentence)
...
def getRegularizationValues():
    ...
    ### YOUR CODE HERE
    #values = [0.0001, 0.0005, 0.001, 0.005, 0.01, 0.05, 0.1, 0.5, 1, 5, 10, 50, 100]
    values = np.arange(0.1, 30, 0.1)
    ### END YOUR CODE
...
def chooseBestModel(results):
    ...
    ### YOUR CODE HERE
    bestResult = results[np.argmax(map(lambda item: item['dev'], results))]
    ### END YOUR CODE
...
if __name__ == "__main__":
    ...
    """
    for --yourvectors:
        Best regularization value: 0.0009
        Test accuracy (%): 30.407240
    for --pretrained:
        Best regularization value: 11.5
        Dev accuracy (%): 37.330
